        ...
        <div class="tour-analytics">
            ...
            <?php else: ?>
                <div class="analytics-grid">
                    ...
                    <div class="analytics-card">
                        <h3>Total Photos Viewed</h3>
                        <div class="value"><?php echo number_format($analytics_data['metrics']['events']); ?></div>
                    </div>
                    
                    <div class="analytics-card">
                        <h3>Avg. Session Duration</h3>
                        <div class="value"><?php echo $this->format_duration($analytics_data['metrics']['avgSessionDuration']); ?></div>
                    </div>
                </div>
                            ...
                            <tbody>
                                <?php foreach ($analytics_data['pages'] as $page): ?>
                                    <tr>
                                        ...
                                        <td><?php echo number_format($page['users']); ?></td>
                                    </tr>
                                <?php endforeach; ?>
                            </tbody>
                        </table>
                ...
                <!-- Traffic Sources -->
                <div class="analytics-table" style="margin-top: 20px;">
                            ...
                            <tbody>
                                <?php foreach ($analytics_data['sources'] as $source): ?>
                                    <tr>
                                        ...
                                        <td><?php echo number_format($source['users']); ?></td>
